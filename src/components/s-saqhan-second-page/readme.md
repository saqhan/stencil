...
graph TD;
  ...
  s-saqhan-second-page --> s-saqhan-line-book
  s-saqhan-second-page --> s-saqhan-quote-text
  s-saqhan-second-page --> s-saqhan-author-info
  s-saqhan-second-page --> s-saqhan-subsc-banner
  s-saqhan-second-page --> s-saqhan-new-blog
  s-saqhan-second-page --> s-saqhan-app-footer
  s-saqhan-line-book --> s-saqhan-card-banner
  s-saqhan-author-info --> s-saqhan-card-author
  s-saqhan-new-blog --> s-saqhan-blog-card
  style s-saqhan-second-page fill:#f9f,stroke:#333,stroke-width:4px
```
